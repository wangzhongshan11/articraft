生成一个桌面级铰接压板/华夫饼机外观机构模型，不包含加热、电气或食品接触要求。包含底座、上盖、上下可替换压板、后部双铰链、前部锁扣和 6 × 6 浅方格阵列。上盖开合范围 0° 到 105°；闭合时上、下压板保持至少 1.0 mm 间隙，避免几何穿插。外壳壁厚至少 2 mm；压板可拆分打印。
输出完整的部件树、关节/锁扣检查、开闭图、STEP/STL/3MF 和 agent trace。
同时交付：
